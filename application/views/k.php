...
<head>
    ...
    <script src="<?php echo JS_PATH;?>html54stock/libs/ajax.js" type="text/javascript"></script>
    <script src="<?php echo JS_PATH;?>html54stock/libs/crossLines.js" type="text/javascript"></script>
    <script src="<?php echo JS_PATH;?>html54stock/libs/axis-x.js" type="text/javascript"></script>
    <script src="<?php echo JS_PATH;?>html54stock/libs/tip.js" type="text/javascript"></script>
    <script src="<?php echo JS_PATH;?>html54stock/libs/linepainter.js" type="text/javascript"></script>
    <script src="<?php echo JS_PATH;?>html54stock/libs/volumePainter.js" type="text/javascript"></script>
    <script src="<?php echo JS_PATH;?>html54stock/libs/axis-y.js" type="text/javascript"></script>
    <script src="<?php echo JS_PATH;?>html54stock/libs/chartEventHelper.js?abc" type="text/javascript"></script>
    <script type="text/javascript" src="<?php echo JS_PATH;?>html54stock/libs/controller.js"></script>
